...
& $GhdlExe -a --std=08 src/mc68881_pkg.vhd src/mc68881_alu.vhd src/mc68881_top.vhd tb/tb_mc68881_alu.vhd tb/tb_mc68881_top.vhd tb/tb_mc68881_fpcr_fpsr.vhd tb/tb_mc68881_ea_cycles.vhd tb/tb_mc68881_cycle_counts.vhd
