...
architecture sim of tb_mc68881_fmovecr is
  ...
  constant FMOVECR_CODES : natural_array_t := (
    ...
    16#3E#, 16#3F#,
    -- Undocumented constants (0x01-0x0A)
    16#01#, 16#02#, 16#03#, 16#04#, 16#05#,
    16#06#, 16#07#, 16#08#, 16#09#, 16#0A#,
    -- Undocumented default range (sample from 0x10-0x2F)
    16#10#, 16#15#, 16#20#, 16#2F#
  );

  constant FMOVECR_EXPECTED : fp80_array_t := (
    -- Documented constants
    x"4000C90FDAA22168C235", -- 0x00: pi
    x"3FFD9A209A84FBCFF798", -- 0x0B: log10(2)
    x"4000ADF85458A2BB4A9A", -- 0x0C: e
    x"3FFFB8AA3B295C17F0BC", -- 0x0D: log2(e)
    x"3FFDDE5BD8A937287195", -- 0x0E: log10(e)
    x"00000000000000000000", -- 0x0F: 0.0
    x"3FFEB17217F7D1CF79AC", -- 0x30: ln(2)
    x"4000935D8DDDAAA8AC17", -- 0x31: ln(10)
    x"3FFF8000000000000000", -- 0x32: 10^0
    x"4002A000000000000000", -- 0x33: 10^1
    x"4005C800000000000000", -- 0x34: 10^2
    x"400C9C40000000000000", -- 0x35: 10^4
    x"4019BEBC200000000000", -- 0x36: 10^8
    x"40348E1BC9BF04000000", -- 0x37: 10^16
    x"40699DC5ADA82B70B59E", -- 0x38: 10^32
    x"40D3C2781F49FFCFA6D5", -- 0x39: 10^64
    x"41A893BA47C980E98CE0", -- 0x3A: 10^128
    x"4351AA7EEBFB9DF9DE8E", -- 0x3B: 10^256
    x"46A3E319A0AEA60E91C7", -- 0x3C: 10^512
    x"4D48C976758681750C17", -- 0x3D: 10^1024
    x"5A929E8B3B5DC53D5DE5", -- 0x3E: 10^2048
    x"7525C46052028A20979B", -- 0x3F: 10^4096
    -- Undocumented constants (WinUAE / Toni Wilen, verified against real silicon)
    x"4001FE00068200000000", -- 0x01: rounding-dependent
    x"4001FFC0050380000000", -- 0x02
    x"20007FFFFFFF00000000", -- 0x03: can set Inf/NaN CC bits
    x"0000FFFFFFFFFFFFFFFF", -- 0x04
    x"3C00FFFFFFFFFFFFF800", -- 0x05
    x"3F80FFFFFF0000000000", -- 0x06
    x"0001F65D8D9C00000000", -- 0x07: sets NaN CC, rounding-dependent
    x"7FFF001E000000000000", -- 0x08
    x"3FFF000E000000000000", -- 0x09
    x"7F000006000000000000", -- 0x0A
    -- Undocumented default (0x10-0x2F all return same value)
    x"40000000000000000000", -- 0x10
    x"40000000000000000000", -- 0x15
    x"40000000000000000000", -- 0x20
    x"40000000000000000000"  -- 0x2F
  );
