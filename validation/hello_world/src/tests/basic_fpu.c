...
static void test_fmovecr_and_add(void)
{
     ...
     *   command = 1_00_000_001_0000000 = 0x8080 (R/M=1, fmt=0=Long, dst=1, op=FMOVE=0x00)
...
static void test_mul_from_single(void)
{
     ...
     *   command = 1_00_001_010_0000000 = 0x8500
     *   3.7f = 0x406CCCCD */
    poke16(pc, 0xF23C); pc += 2;
    ...
    /* FMOVE.S #2.4, FP3:
     *   command = 1_00_001_011_0000000 = 0x8580
     *   2.4f = 0x4019999A */
    poke16(pc, 0xF23C); pc += 2;
...
static void test_fsin(void)
{
    ...
    /* FMOVE.L #1, FP0:
     *   opword=F23C, command=0x8000 (R/M=1,fmt=0=Long,dst=0,op=FMOVE)
     *   imm = 0x00000001 */
    poke16(pc, 0xF23C); pc += 2;
